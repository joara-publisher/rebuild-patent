    ...
    <article class="counsellingArti ani">
        <div class="inner">
            ...
            <div class="tabCont">
                ...
                <div class="contSubTit">모든 상담은 변리사가 직접 답변 드립니다.</div>
                <div class="cont">
                    <div class="searchBox">
                    ...
                    <div class="tableWrap pcTable">
                        <table style="table-layout: fixed">
                            ...
                            <?php
                                ...
                                foreach($boards as $b):
                                ?>
                                    <tr onClick="location.href='/counseling/check/<?=$b['no']?>'">
                                        <td><?=sprintf('%04d', $i);?></td>
                                        <td style="width:65%; text-overflow:ellipsis; overflow:hidden; white-space:nowrap"><?=$b['title']?></td>
                        ...
                        <table style="table-layout: fixed">
                            ...
                            <?php
                                ...
                                ?>
                                    <tr onClick="location.href='/counseling/check/<?=$b['no']?>'">
                                        <td><?=sprintf('%04d', $i);?></td>
                                        <td style="text-overflow:ellipsis; overflow:hidden; white-space:nowrap"><?=$b['title']?></td>
                                        <td><?=cu_mask_name($b['name'])?></td>
                                        <td><?=cu_conv_date($b['create_date'])?></td>
                                        <td><div class="status <?=($b['status']=='complete')? '' : 'not_' ?>complete"><?=($b['status']=='complete')? '접수완료' : '상담신청' ?></div></td>
                                    </tr>
