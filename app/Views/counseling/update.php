            ...
            <div class="formWrap">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <ul class="formList">
                        ...
                        <li>
                            <label for="content">문의내용</label> <span class="noti">50자 이상</span>
                            <textarea class="ipt" id="content" name="content" minlength ="50" placeholder="상담 받으실 내용을 입력해주세요."></textarea>
                        </li>
                        <li>
                    ...
                    <button type="button" class="btnCsApply ga_board">상담신청완료</button>
                </form>
            </div>
        </section>
    </div>
